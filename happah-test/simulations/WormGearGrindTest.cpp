...
WormGearGrindTest::WormGearGrindTest(SceneManager* sceneManager) {
  ...
  InvoluteGear* worm = new InvoluteGear(30, 0.13f, 0.2f, M_PI / 6.0f, 0.00f, 0.00f, 0.00f, "Worm");
  InvoluteGear* gear = new InvoluteGear(15, 0.13f, 0.2f, M_PI / 6.0f, 0.00f, 0.00f, 0.00f, "Gear");
