...
WormGearGrindTest::WormGearGrindTest(SceneManager* sceneManager) {
  ...
  InvoluteSpurGear* worm = new InvoluteSpurGear(30, 0.13f, 0.2f, M_PI / 6.0f, 0.00f, 0.00f, 0.00f, "Worm");
  InvoluteSpurGear* gear = new InvoluteSpurGear(15, 0.13f, 0.2f, M_PI / 6.0f, 0.00f, 0.00f, 0.00f, "Gear");
