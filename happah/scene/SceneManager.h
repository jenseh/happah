...
public:
	...
	template <class T> LineMeshRenderStateNode_ptr insert(shared_ptr<BSplineCurve<T>> curve, LineMesh3D_ptr LineMesh, hpcolor&color);
	...
	LineMeshRenderStateNode_ptr insert(FocalSpline_ptr focalSpline, LineMesh3D_ptr LineMesh, hpcolor&color);
	...
	LineMeshRenderStateNode_ptr insert(Plane_ptr plane, LineMesh3D_ptr LineMesh,hpcolor&color);
	template <class T> void insert(Plane_ptr plane, shared_ptr<BSplineCurve<T>> curve);
	LineMeshRenderStateNode_ptr insert(SimpleGear_ptr simpleGear, LineMesh3D_ptr lineMesh, hpcolor& color);
	...
	LineMeshRenderStateNode_ptr insert(ToothProfile_ptr toothProfile, LineMesh3D_ptr lineMesh, hpcolor& color);
...
private:
	...
	template<class G, class N>
	LineMeshRenderStateNode_ptr doInsert(shared_ptr<G> geometry, LineMesh3D_ptr lineMesh, hpcolor& color);
	template<class G, class N>
	LineMeshRenderStateNode_ptr doInsert(shared_ptr<G> geometry, LineMesh3D_ptr lineMesh, vector<hpcolor>* color, RigidAffineTransformation& transformation);
	template<class G, class N>
	LineMeshRenderStateNode_ptr doInsert(shared_ptr<G> geometry, LineMesh3D_ptr lineMesh, hpcolor& color, RigidAffineTransformation& transformation);
